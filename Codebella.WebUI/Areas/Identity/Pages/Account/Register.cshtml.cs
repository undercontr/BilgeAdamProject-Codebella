...
namespace Codebella.WebUI.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var resultAuthor = await _authorManager.AddAsync(author);
                user.AuthorId = author.Id;

                var resultUser = await _userManager.CreateAsync(user, Input.Password);

                if (resultUser.Succeeded && resultAuthor.Success)
                {
